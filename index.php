...
<html lang="de">
    ...
    <body>
        ...
        <nav class="border-radius nav">
            <ul>
                <li><a href="http://der-vertretungsplan.de/">Aktualisieren</a></li>
                <li><a href="http://der-vertretungsplan.ietherpad.com/1" target="_blank">Mitwirken: Pad</a></li>
                <li><a href="https://github.com/phi1010/der-vertretungsplan" target="_blank">Mitwirken: GITHUB</a></li>
                <li><a href="http://webchat.esper.net/?channels=#vertretungsplan" target="_blank">IRC-Channel</a></li>
            </ul>
        </nav>
        <section>
